...
ap.add_argument("-s", "--save", action="store_true", help="Store to the image")
...
for i in xrange(0, 3):
    ...
    if args["save"] is None:
        ...
        cv2.imwrite("Eroded-%d-times.jpg" % (i + 1), eroded)
...
for i in xrange(0, 3):
    ...
    if args["save"] is None:
        ...
        cv2.imwrite("Dilated-%d-times.jpg" % (i + 1), dilated)
...
for kernelSize in kernelSizes:
    ...
    if args["save"] is None:
        ...
        cv2.imwrite("Opening-%d-%d.jpg" % (kernelSize[0], kernelSize[1]), opening)
...
for kernelSize in kernelSizes:
    ...
    if args["save"] is None:
        ...
        cv2.imwrite("Closing-%d-%d.jpg" % (kernelSize[0], kernelSize[1]), opening)
...
for kernelSize in kernelSizes:
    ...
    if args["save"] is None:
        ...
        cv2.imwrite("Gradient-%d-%d.jpg" % (kernelSize[0], kernelSize[1]), gradient)
